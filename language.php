...
else
{
    $lang_array=array(
        ...
        "documentation_lang"=>"Библиотека технической документации РПКБ",
        ...
        "main_desc_lang"=>"Библиотека технической документации РПКБ - это ваш надежный источник документации разработчика. Каждый день мы предоставляем самую свежую информацию для вашей локальной справки.",
